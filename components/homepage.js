...
function HomePage() {
    ...
    return (
        <div className=" grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 mb-5 place-items-center h-[87vh] items-center justify-center text-center overflow-scroll w-12/12  max-w-10xl  z-20">
